...
contract RewardControl is IRewardControl, ExponentialNoError {
    ...
    // @notice The underlying TauVault contract
    TauVault public deltaOpen;
    ...
    function setTauVault(address tauVault_) public onlyOwner {
        require(tauVault_ != address(0), "Address is empty");
        deltaOpen = TauVault(tauVault_);
    }
