...
async function validateStrictOraclePriceFeed(priceFeedInfo: StrictTauPriceOraclePriceFeed) {
...
async function main() {
  ...
  for(const strictTauPriceOraclePriceFeed of config.PriceFeed.StrictTauPriceOraclePriceFeed) {
    validateStrictOraclePriceFeeds.push(validateStrictOraclePriceFeed(strictTauPriceOraclePriceFeed))
  }
