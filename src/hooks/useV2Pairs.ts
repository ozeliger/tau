...
import { SOLAR_ADDRESS, FACTORY_ADDRESS, TAU_DISTRIBUTOR_ADDRESS, TAU_VAULT_ADDRESS, tokenAddressToToken } from "../constants"
...
export function useVaultTVL(): TVLInfo[] {
    ...
    return useMemo(() => {
        ...
        function getPrice(token: TokenInfo) {
            ...
            if(token.symbol == "wFIL" || token.symbol == "FIL") {
                return xdcPrice
            }
