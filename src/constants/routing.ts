...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
    ...
    [ChainId.HYPERSPACE]: [WNATIVE[ChainId.HYPERSPACE]]
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
    ...
    [ChainId.HYPERSPACE]: [...WRAPPED_NATIVE_ONLY[ChainId.HYPERSPACE]],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
    ...
    [ChainId.HECO]: [...WRAPPED_NATIVE_ONLY[ChainId.HECO], HECO.DAI, HECO.USDC, HECO.USDT, HECO.WBTC, HECO.WETH],
    [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], OKEX.DAI, OKEX.USDC, OKEX.USDT, OKEX.WBTC, OKEX.WETH],
    [ChainId.HYPERSPACE]: [...WRAPPED_NATIVE_ONLY[ChainId.HYPERSPACE], HYPERSPACE.DCT, HYPERSPACE.MAV, HYPERSPACE.WLR, HYPERSPACE.DIB]
}
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
    ...
    [ChainId.HYPERSPACE]: deployments.swap.TauRouter02,
}
