...
export const MOONRIVER: { [key: string]: Token } = {
    ...
    SOLAR: new Token(ChainId.MOONRIVER, "0x6bD193Ee6D2104F14F94E2cA6efefae561A4334B", 18, "SOLAR", "Tau Token"),
...
export const HYPERSPACE: { [key: string]: Token } = {
    wFIL: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.wFIL, 18, "wFIL", "Wrapped FIL"),
    TAU: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.TAU, 18, "TAU", "TAU Token"),
    DCT: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.HYPERSPACE, getDeployedAddresses().tokens.DIB, 18, "DIB", "Dib Token"),
}
...
export const SOLAR_ADDRESS = {
    ...
    [ChainId.HYPERSPACE]: deployments.tokens.TAU,
}

export const SOLAR: ChainTokenMap = {
    [ChainId.HYPERSPACE]: new Token(ChainId.HYPERSPACE, SOLAR_ADDRESS[ChainId.HYPERSPACE], 18, "TAU", "Tau Token"),
    [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, SOLAR_ADDRESS[ChainId.MOONRIVER], 18, "SOLAR", "Tau Token"),
}
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
    ...
    [SupportedChainId.HYPERSPACE]: new Token(
        ChainId.HYPERSPACE,
