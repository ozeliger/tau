...
export default function Farm(): JSX.Element {
    ...
    let summTvlVaults = vaults.reduce((previousValue, currentValue) => previousValue + (currentValue.totalLp / 1e18) * tauPrice, 0)
    ...
    const map = (pool) => {
        ...
        function getRewards() {
            const rewardPerBlock = ((pool.allocPoint / distributorInfo.totalAllocPoint) * distributorInfo.tauPerBlock) / 1e4
