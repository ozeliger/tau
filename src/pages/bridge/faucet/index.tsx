    ...
    return (
        <>
            <Head>
                ...
                <meta key="description" name="description" content="Tau Faucet" />
            </Head>
                        ...
                        <div className="h-[570px] flex flex-col justify-center items-center">
                            <div className="p-4 mb-3 space-y-3 text-center">
                                <Typography component="h1" variant="base">
                                    The faucet provides you with some test tokens for you to test out this app. These tokens do not have any value, and only exist on the Hyperspace Network.
                                    Use it wisely!
                                </Typography>
                            </div>
