                                        ...
                                        <div className={`hidden md:block`}>
                                            <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                                                ...
                                                <div className="mb-4 text-base text-secondary">
                                                    <p>
                                                        {`taUSD is an`} <strong>overcollateralized</strong>, <strong>auto-farming</strong>, and 
                                                        <strong> decentralized</strong> {`stablecoin reinforced with multi-layered
                                                ...
                                                <div className={`flex flex-col items-center justify-between px-6 py-6 `}>
                                                    <div className="flex items-center text-center justify-between py-2 text-emphasis">
                                                        taUSD Balance: {formatNumberScale(fromDecimals(taUSDBalance?.value.toString() ?? "0"), true, 2)}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
