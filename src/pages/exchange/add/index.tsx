...
export default function Add() {    
    ...
    const [currencyIdA, currencyIdB] = (JSON.parse(localStorage?.getItem(ADD_JSON_STORAGE))?.tokens as string[]) || [undefined, undefined]
        ...
        return noLiquidity ? (
            ...
            <div className="pb-4">
                ...
                <div className="pt-3 text-xs italic text-secondary">
                    {`Output is estimated. If the price changes by more than ${allowedSlippage.toSignificant(4)}% your transaction will revert.`}
                </div>
            </div>
        )
    }
        ...
        <>
            <Head>
                ...
                <meta
                    key="description"
                    name="description"
                    content="Add liquidity to the Tau AMM to enable gas optimised and low slippage trades across countless networks"
                />
            </Head>
